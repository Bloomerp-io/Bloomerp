...
from bloomerp.lookups.builtins.less_or_equal_than import LESS_THAN_OR_EQUAL
...
class TestLessThanOrEqualLookup(BloomerpLookupTestCase):
    ...
    def get_test_scenarios(self) -> list[LookupScenario]:
        return [
            LookupScenario(
                ...
                value="25",
                sql_value=25,
                expected_lookup=CompiledLookup(predicate=Q(age__lte=25)),
