...
from bloomerp.lookups.builtins.greater_than import GREATER_THAN
...
class TestGreaterThanLookup(BloomerpLookupTestCase):
    lookup = GREATER_THAN
    ...
    def get_test_scenarios(self) -> list[LookupScenario]:
        return [
            LookupScenario(
                ...
                value="25",
                sql_value=25,
                expected_lookup=CompiledLookup(predicate=Q(age__gt=25)),
