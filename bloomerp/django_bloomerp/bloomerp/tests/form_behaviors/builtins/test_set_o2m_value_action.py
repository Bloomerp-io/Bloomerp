...
class TestSetO2mValueAction(BloomerpBehaviorActionTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        fixtures = create_test_models("bloomerp", {
            "BehaviorProduct": {"sales_price": models.DecimalField(max_digits=10, decimal_places=2)},
            ...
            "BehaviorInvoiceLine": {
                ...
                "product": models.ForeignKey("bloomerp.BehaviorProduct", on_delete=models.CASCADE),
    ...
    def resolve_prices(
        self, source: ApplicationField, accessor: ApplicationField, identities: tuple[Any, ...],
    ) -> dict[str, Any]:
    ...
    def get_test_scenarios(self) -> list[BehaviorActionScenario]:
        ...
        rows = [
            {"id": "line-1", "product": "product-1", "rate": Decimal("0.00"), "quantity": 3, "note": "Keep me"},
            {"id": "line-2", "product": "product-1", "rate": Decimal("25.00"), "quantity": 7},
            {"product": "", "rate": Decimal("12.00"), "note": "Unselected draft"},
            {"id": "line-4", "product": "deleted-product", "rate": Decimal("9.00"), "DELETE": True},
        ]
        ...
        return [BehaviorActionScenario(
            ...
            context=BehaviorContext(
                values={"lines": rows}, listener_field="lines", target_field="lines",
                resolve_related_values=self.resolve_prices,
            ),
            listener=target, target=target,
            config={"from_column": "product", "accessor": "sales_price", "to_column": "rate"},
