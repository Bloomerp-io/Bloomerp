...
class PreviewWorkspaceTile(TemplateView):
    template_name = "components/workspaces/tiles/preview.html"
    ...
    def get_tile_builder_template(self):
        ...
        match self.get_tile_type_key():
            case "ANALYTICS_TILE":
                return "components/workspaces/tiles/builders/analytics.html"
            case "LINKS_TILE":
                return "components/workspaces/tiles/builders/links.html"
            case "TEXT_TILE":
                return "components/workspaces/tiles/builders/text.html"
            case "CANVAS_TILE":
                return "components/workspaces/tiles/builders/canvas.html"
            # case TileType.FORM_TILE:
            #     return "components/workspaces/tiles/builders/form.html"
            case _:
                return "components/workspaces/tiles/builders/default.html"
