...
SECRET_KEY = 'django-insecure-tv$m7syy_=7e&airoxc=ge&kyo37=fq=pe+(sa+#ut(9y*!3hz'
...
FORM_RENDERER = "django.forms.renderers.TemplatesSetting" # TODO: add a validator that this NEEDS to be included
